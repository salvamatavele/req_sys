<nav x-data="{ open: false }" class="bg-danger  border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @endif
                    <x-nav-link :href="route('requests.index')" :active="request()->routeIs('requests.index') || request()->routeIs('requests.create') || request()->routeIs('requests.send')">
                        {{ 'Expedientes' }}
                    </x-nav-link>
                </div>
            </div>
